...
class CouldNotConnectToDomain(Exception):
    def __init__(self):
        self.message = "It was not possible to connect to the Domain Service"
        super().__init__(self.message)

    def __str__(self):
        return self.message

class CouldNotConnectToCatalogue(Exception):
    def __init__(self):
        self.message = "It was not possible to connect to the Catalogue Service"
        super().__init__(self.message)
