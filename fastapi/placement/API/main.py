...
async def startup_event():
    ...
    teste = MessageSchemas.Message(
        vsiId="3",
        msgType="createVSI",
        tenantId="989559bf-10ca-4cc7-a3e7-b6604466dc52"
    )
    teste.data = data
